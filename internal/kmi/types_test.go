...
func Test_Account2Marshalling(t *testing.T) {
	data, err := os.ReadFile("account_test2.xml")
	...
	var names []string
	for _, grp := range e1.Group {
		//get grp name
		names = append(names, fmt.Sprintf("\"%s\"", grp.Name))
	}
	fmt.Println(names)
...
func Test_IdentityEngineMarshalling(t *testing.T) {
	...
	<option name="cas_base64" source="restserv:user:hachandr_kmi_cert"></option>
	<option name="endpoint_url" source="restserv:user:hachandr_kmi_cert">https://4a7de7c1-0276-40cc-bd61-c50a89a9c553.cpc2-us-central.linodelke.net:443</option>
...
func Test_IdentityEngineMarshallingSecond(t *testing.T) {
	data := []byte(`<engine name="pi-dev-usiad-l1-2023-1127-121839" cloud="linode" type="kubernetes" adders="PIM_TEST_admins" modifiers="PIM_TEST_admins" modified="355322586" source="restserv:user:hachandr_kmi_cert" published="2024-01-13 17:30:12" published_location="/secret/Col=kmi_identity_engines/Def=PIM_TEST.pi-dev-usiad-l1-2023-1127-121839/Idx=355322586"><option name="cas_base64" source="restserv:user:hachandr_kmi_cert"></option><option name="endpoint_url" source="restserv:user:hachandr_kmi_cert">https://fbfcd97b-cf7b-4ce6-8736-1abbd7e072b1.us-iad-1.linodelke.net:443</option><workload projection="instance_validator"/></engine>`)
	var e1 IdentityEngine
	err := xml.Unmarshal(data, &e1)
	if err != nil {
		log.Fatal(err)
